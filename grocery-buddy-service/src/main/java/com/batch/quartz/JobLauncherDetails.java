...
public class JobLauncherDetails extends QuartzJobBean {
	...
	/**
	 * * Public setter for the {@link JobLocator}. * @param jobLocator the
	 * {@link JobLocator} to set
	 */
	...
	/**
	 * * Public setter for the {@link JobLauncher}. * @param jobLauncher the
	 * {@link JobLauncher} to set
	 */
	 ...
	 * JobParameters}, ignoring jobName. * * @return a {@link JobParameters}
	 * instance
	 */
	...
	private JobParameters getJobParametersFromJobMap(
		...
		//this is to make sure that the same job runs the next time it is called by quartz
